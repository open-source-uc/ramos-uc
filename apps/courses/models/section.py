...
class SectionQuerySet(models.QuerySet):
    ...
    def search(self, query):
        ...
        return (self.filter(models.Q(course__name__unaccent__icontains=query) |
...
class Section(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['period', 'course', 'section'],
                                    name='period_section')
        ]
    ...
    def quota_list(self):
        return list(self.quota_set.all().order_by('date')
    ...
    def last_quota(self):
        return self.quota_set.extra(
                    ...
                    params=[self.id]).values('date', 'category', 'quota')
