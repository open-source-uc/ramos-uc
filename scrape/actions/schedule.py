...
def process_schedule(text_sc):
    ...
    full_sc_query = f'INSERT INTO courses_fullschedule (section_id, {cols}) VALUES (%s, {values});'
    ...
    info_sc_query = f'INSERT INTO courses_scheduleinfo (section_id, {cols}) VALUES (%s, {values});'
