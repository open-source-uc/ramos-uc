...
GET_SECTION_ID = (
    "SELECT courses_section.id FROM courses_section, courses_course "
...
CREATE_COURSE = (
    "INSERT INTO courses_course (initials, name, credits, req, con, restr, program, school, area, category) "
...
CREATE_SECTION = (
    "INSERT INTO courses_section (course_id, period, section, nrc, teachers, "
...
UPDATE_COURSE = (
    "UPDATE courses_course SET name=%s, credits=%s, req=%s, con=%s, restr=%s, program=%s, area=%s, category=%s "
    + "WHERE initials=%s;"
)

# (name, credits, area, category, initials)
HALF_UPDATE_COURSE = (
    "UPDATE courses_course SET name=%s, credits=%s, area=%s, category=%s "
    + "WHERE initials=%s;"
)

# (teachers, schedule, format, campus, is_english, is_removable, is_special, available_quota, total_quota, section_id)
UPDATE_SECTION = (
    "UPDATE courses_section SET teachers=%s, schedule=%s, format=%s, campus=%s, is_english=%s, "
